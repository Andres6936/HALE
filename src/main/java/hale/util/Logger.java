...
public class Logger
{
     ...
     * warning log at "log/warning.log".  If {@link main.java.hale.Config#isWarningModeEnabled()}
     ...
     * If {@link main.java.hale.Config#isDebugModeEnabled()} then the error (but not the stack trace)
     ...
     * "log/error.log".  If {@link main.java.hale.Config#isDebugModeEnabled()} then the error and
